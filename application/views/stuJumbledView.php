...
<a href="<?php echo base_url();?>stu/jumblQuesView" type="button" data-toggle="modal"  data-target="#exampleModalLong" class="btn btn-primary" id="jumlQuestions">Let's Start</a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="<?php echo base_url();?>stu/jumblQuesView" type="button" class="btn btn-primary" id="jumlQuestions">Start Exam</a>
