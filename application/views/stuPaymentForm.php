...
<div class="modal fade" id="basicsub" tabindex="-1" role="dialog" aria-labelledby="basicsubTitle" aria-hidden="true">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="name" value= "<?php echo $user_data['stuFullname'] ? $user_data['stuFullname'] : NULL; ?>">
  </div>
  <div class="form-group">
    <label for="email">Email address:</label>
    <input type="email" class="form-control" name="email" value= "<?php echo $user_data['stuEmail'] ? $user_data['stuEmail'] : NULL; ?>">
  </div>
   <!-- Copy Paste the MaRRs Razorpay account respective plan_id here instead -->
    <input type="hidden" class="form-control" name="plan_id" value="plan_A1m8z3J8SAIOaO">
      </div>
...
<div class="modal fade" id="magentasub" tabindex="-1" role="dialog" aria-labelledby="magentasubTitle" aria-hidden="true">
  ...
  <div class="form-group">
   ...
   <!-- Copy Paste the MaRRs Razorpay account respective plan_id here instead -->
    <input type="hidden" class="form-control" name="plan_id" value="plan_A1mA7eFH5zyfsN">
      </div>
      <div class="modal-footer">
...
<div class="modal fade" id="yellowsub" tabindex="-1" role="dialog" aria-labelledby="yellowsubTitle" aria-hidden="true">
  ...
  <div class="form-group">
   ...
   <!-- Copy Paste the MaRRs Razorpay account respective plan_id here instead -->
   <input type="hidden" class="form-control" name="plan_id" value="plan_A1m8G9XozedDnY">
      </div>
      <div class="modal-footer">
...
<div class="modal fade" id="basicpay" tabindex="-1" role="dialog" aria-labelledby="basicpayTitle" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <form action="<?php echo base_url('payment/subscr');?>" method="POST">
            
<!-- Note that the amount is in paise = 50 INR -->
<script
    src="https://checkout.razorpay.com/v1/checkout.js"
    data-key="rzp_test_w24skZJGArPSvr"
    total_count="6",
    customer_notify="1",
    data-amount="15000"
